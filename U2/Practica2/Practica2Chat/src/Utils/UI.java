...
public class UI {
    ...
    private final static String CONNECTION_ON = "Conectando con el servidor";
    private final static String IDENTIFICATION = "Conexion realizada con exito";
    ...
    public static void connectedUserID(String identificador) {
